            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <a href="productManagement.jsp" class="btn btn-primary">Manage Products</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <a href="stockManagement.jsp" class="btn btn-primary">Manage Stock</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <a href="discountManagement.jsp" class="btn btn-primary">Manage Discounts</a>
                    </div>
                </div>
            </div>
        </div>
